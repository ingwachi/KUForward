...
import header from '../image/headerClothes.png';
...
class ClothesStore extends React.Component {
    ...
    showModal = (id) => {
        ...
        db.collection('stockShirt').doc(`${id}`).get()
            .then((doc) => {
        ...
        return (
            <div className="store">
                ...
                <div className="setButtonGroup">
                    ...
                    <Button type="primary" id="distButton">Clothes</Button>
