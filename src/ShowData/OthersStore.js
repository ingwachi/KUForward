...
import header from '../image/headerOthers.png';
...
class OthersStore extends React.Component {
    ...
    showModal = (id) => {
        ...
        db.collection('stockOther').doc(`${id}`).get()
            .then((doc) => {
        ...
        return (
            <div className="store">
                ...
                <div className="setButtonGroup">
                    <Link to="/Book"><Button type="distButton" id="distButton">BOOKS</Button></Link>
                    <Link to="/ClothesStore"><Button type="distButton" id="distButton">Clothes</Button></Link>
                    <Link to="/AccessoriesStore"><Button type="distButton" id="distButton">Accessories</Button></Link>
                    <Button type="primary" id="distButton">Others</Button>
