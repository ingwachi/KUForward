...
import header from '../image/headerAccessories.png';
...
class AccessoriesStore extends React.Component {
    ...
    componentDidMount() {
        // const temp = [];
        let wholedata = [];
        db.collection('stockAccessary').get()
            .then((res) => {
                res.forEach(doc => {
                    var temp = [];
                    temp.push(doc.id)
    ...
    showModal = (id) => {
        ...
        db.collection('stockAccessary').doc(`${id}`).get()
            .then((doc) => {
            ...
            <div>
                <div className="store">
                    ...
                    <div className="setButtonGroup">
                        ...
                        <Button type="primary" id="distButton">Accessories</Button>
