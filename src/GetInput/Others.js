...
import headOthers from '../image/cateOther.png';
...
class Others extends React.Component{
    ...
    componentDidMount(){
        db.collection('stockOther').get().then((snapshot)=>{
    ...
    addEventListener = e=>{
        ...
        .then(docRef => {
            ...
            window.location.href = "/OthersStore"
        })  
    }
    ...
    render(){
        ...
        return (
            <div className="AddInfoPage">
                ...
                <div>
                    <img src = {headOthers} id ="headbookct"/>
                </div>
                <div>
