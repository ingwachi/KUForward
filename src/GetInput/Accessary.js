...
import headAccessory from '../image/cateAcces.png'
...
class Accessary extends React.Component{
    constructor(props){
        super(props)
    ...
    componentDidMount(){
        db.collection('stockAccessary').get().then((snapshot)=>{
    ...
    addEventListener = e=>{
        e.preventDefault();
        db.collection('stockAccessary').add({
        ...
        .then(docRef => {
            ...
            window.location.href = "/AccessoriesStore"
        })   
    }
    ...
    render(){
        ...
        return (
            <div className="AddInfoPage">
                ...
                <div>
                    <img src = {headAccessory} id ="headbookct"/>
                </div>
                <div>
